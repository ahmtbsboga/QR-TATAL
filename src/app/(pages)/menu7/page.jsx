...
export default function ProductsPage() {
  ...
  useEffect(() => {
    const fetchMeze = async () => {
      const querySnapshot = await getDocs(collection(db, "meze"));
      const fetchedMeze = querySnapshot.docs.map((doc) => ({
        id: doc.id,
        ...doc.data(),
      }));
      setMeze(fetchedMeze);
  ...
  return (
    <div className="min-h-screen text-black relative">
      ...
      <h1 className="text-center font-bold mt-20 text-3xl">İKRAMLARIMIZ</h1>
      {/* ızgara listesi */}
