...
//   useEffect(() => {
//     const fetchCategory = async (category, setFunction) => {
...
//     fetchCategory("products", setProducts);
//     fetchCategory("soup", setSoups);
//     fetchCategory("pide", setPide);
//     fetchCategory("breakfast", setBreakfast);
//     fetchCategory("sweets", setSweets);
//     fetchCategory("drinks", setDrinks);
//   }, []);
